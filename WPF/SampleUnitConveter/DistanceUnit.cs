...
namespace SampleUnitConverter
{
    ...
    public class MetricUnit : DistanceUnit
    {
        ...
        public double FromImperiaUnit(ImperuaUnit unit,double value)
        {
    ...
    //ヤード単位を表すクラス
    public class ImperuaUnit : DistanceUnit
    {
        private static List<ImperuaUnit> units = new List<ImperuaUnit>
        {
            new ImperuaUnit {Name ="in",Coefficient = 1, },
            new ImperuaUnit {Name ="ft",Coefficient = 12, },
            new ImperuaUnit {Name ="yd",Coefficient = 12*3, },
            new ImperuaUnit {Name ="ml",Coefficient = 12*3*1760, },
        };
        public static ICollection<ImperuaUnit> Units { get { return units; } }
